...
> **Context.** Step 12 of the devmm v0.1 build. Authoritative spec: [`specs/devmm-design.md`](../devmm-design.md); build order: [`specs/devmm-implementation-plan.md`](../devmm-implementation-plan.md) (Phase 12). Design sections: §9, §10. This step depends on **p11-integrations** landing first.
