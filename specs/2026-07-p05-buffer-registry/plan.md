...
> **Context.** Step 05 of the devmm v0.1 build. Authoritative spec: [`specs/devmm-design.md`](../devmm-design.md); build order: [`specs/devmm-implementation-plan.md`](../devmm-implementation-plan.md) (Phase 5). Design sections: §3.4, §3.5. This step depends on **p04-cpu-mrs** landing first.
